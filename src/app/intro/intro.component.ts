...
// 노란 꽃술이 있는 흰꽃 — 흰 꽃잎(3×3) + 노란 중심(1×1)
const SCENE_COMPOUND_FLOWERS: { x: number; y: number; d: number }[] = [
  {x:377,y:130,d:1.01}, // 우측 상단 꽃군
  {x:367,y:132,d:0.38},
  {x:387,y:144,d:1.25},
  {x:353,y:154,d:0.50},
  {x: 12,y:130,d:0.43}, // 좌측
  {x: 15,y:146,d:0.45},
  {x:304,y:158,d:1.23},
  {x:275,y:160,d:0.57},
];

// 흰꽃 — 양 끝(x<90 또는 x>300) 위치만 포함
const SCENE_WHITE_FLOWERS: { x: number; y: number; d: number }[] = [
  // 기존 25개 (가장자리)
  {x:378,y:134,d:0.42}, {x:365,y:135,d:1.13}, {x:374,y:136,d:0.78},
  {x:386,y:136,d:1.55}, {x:  7,y:143,d:0.33}, {x:388,y:143,d:2.01},
  {x:328,y:144,d:0.67}, {x: 48,y:145,d:1.44}, {x: 59,y:145,d:0.91},
  {x:317,y:148,d:1.82}, {x:361,y:151,d:0.54}, {x:307,y:152,d:2.23},
  {x:297,y:153,d:0.38}, {x:319,y:156,d:1.67}, {x:311,y:157,d:0.88},
  {x:361,y:157,d:2.44}, {x:333,y:161,d:1.29},
  {x: 29,y:162,d:0.55}, {x: 69,y:165,d:1.93}, {x: 76,y:168,d:0.46},
  {x:330,y:168,d:2.17}, {x: 52,y:169,d:0.83},
  // 추가 — 좌측(x<90)
  {x: 40,y:141,d:0.91}, {x: 14,y:146,d:1.23}, {x: 48,y:146,d:0.37},
  {x: 13,y:149,d:0.36}, {x: 20,y:150,d:1.73}, {x: 21,y:152,d:0.78},
  {x: 59,y:153,d:2.08}, {x: 28,y:154,d:0.31}, {x: 81,y:154,d:2.07},
  {x: 89,y:154,d:1.84}, {x: 33,y:156,d:0.51}, {x: 44,y:158,d:2.16},
  {x: 71,y:158,d:1.63}, {x:  8,y:159,d:1.91}, {x: 30,y:160,d:2.12},
  // 추가 — 우측(x>300)
  {x:390,y:135,d:1.71}, {x:352,y:138,d:0.36}, {x:334,y:142,d:0.79},
  {x:354,y:143,d:1.92}, {x:328,y:144,d:1.79}, {x:340,y:144,d:2.26},
  {x:380,y:144,d:0.49}, {x:387,y:146,d:0.78}, {x:322,y:147,d:1.41},
  {x:373,y:149,d:0.74}, {x:360,y:151,d:1.50}, {x:307,y:152,d:1.60},
  {x:319,y:154,d:1.05}, {x:366,y:154,d:0.64}, {x:320,y:155,d:1.04},
  {x:352,y:155,d:0.50}, {x:311,y:159,d:1.48}, {x:338,y:159,d:2.44},
  {x:352,y:159,d:1.13}, {x:362,y:159,d:1.51}, {x:303,y:162,d:1.85},
];

// Flowers extracted from image (x, y in SVG 400×172 space, s=size, d=animation-delay, c=color)
const SCENE_FLOWERS: { x: number; y: number; s: number; d: number; c: string }[] = [
  {x:0,   y:121, s:2, d:0.56, c:'#e4c94b'}, {x:13,  y:121, s:1, d:0.57, c:'#dfc552'},
  {x:24,  y:124, s:1, d:0.89, c:'#e4c94b'}, {x:35,  y:132, s:1, d:2.93, c:'#e4c94b'},
  {x:45,  y:132, s:1, d:1.08, c:'#dcc34b'}, {x:55,  y:130, s:3, d:2.02, c:'#dfc552'},
  {x:66,  y:132, s:1, d:0.58, c:'#dfc552'}, {x:75,  y:135, s:2, d:1.12, c:'#e4c94b'},
  {x:84,  y:136, s:3, d:0.73, c:'#e4c94b'}, {x:94,  y:136, s:3, d:2.65, c:'#e4c94b'},
  {x:104, y:141, s:1, d:2.88, c:'#e4c94b'}, {x:115, y:145, s:1, d:1.85, c:'#e4d55a'},
  {x:124, y:142, s:2, d:2.87, c:'#e4c94b'}, {x:130, y:144, s:1, d:1.56, c:'#dfc552'},
  {x:139, y:138, s:1, d:1.79, c:'#e4d55a'}, {x:147, y:144, s:1, d:0.83, c:'#dfc552'},
  {x:154, y:121, s:4, d:0.74, c:'#e4d55a'}, {x:159, y:148, s:1, d:2.65, c:'#dfc552'},
  {x:163, y:121, s:4, d:2.59, c:'#e4d55a'}, {x:168, y:145, s:2, d:0.89, c:'#e4c94b'},
  {x:172, y:120, s:3, d:0.64, c:'#e4d55a'}, {x:178, y:123, s:3, d:2.05, c:'#e4d55a'},
  {x:183, y:138, s:1, d:0.68, c:'#e4d55a'}, {x:187, y:121, s:2, d:2.58, c:'#dfd461'},
  {x:191, y:141, s:1, d:0.84, c:'#e4d55a'}, {x:195, y:127, s:1, d:1.19, c:'#e7d567'},
  {x:199, y:118, s:4, d:0.52, c:'#e4d55a'}, {x:202, y:108, s:4, d:0.82, c:'#dfd461'},
  {x:204, y:150, s:1, d:0.56, c:'#e4c94b'}, {x:209, y:147, s:1, d:0.77, c:'#e4c94b'},
  {x:214, y:109, s:3, d:2.66, c:'#e7d567'}, {x:218, y:139, s:1, d:0.77, c:'#dfc552'},
  {x:226, y:140, s:1, d:2.62, c:'#e4d55a'}, {x:234, y:144, s:1, d:2.14, c:'#e4c94b'},
  {x:241, y:139, s:1, d:1.79, c:'#dcc34b'}, {x:246, y:146, s:1, d:0.68, c:'#dcc34b'},
  {x:256, y:131, s:1, d:0.51, c:'#e4d55a'}, {x:264, y:141, s:3, d:1.99, c:'#e4c94b'},
  {x:270, y:136, s:2, d:1.15, c:'#dfd461'}, {x:276, y:129, s:2, d:1.85, c:'#dfd461'},
  {x:282, y:138, s:2, d:1.96, c:'#e4c94b'}, {x:291, y:133, s:1, d:1.55, c:'#e4c94b'},
  {x:297, y:120, s:1, d:2.20, c:'#dfd461'}, {x:303, y:135, s:4, d:0.84, c:'#e4c94b'},
  {x:314, y:138, s:1, d:0.70, c:'#e4c94b'}, {x:325, y:132, s:1, d:0.55, c:'#e4c94b'},
  {x:335, y:132, s:1, d:2.37, c:'#dfc552'}, {x:349, y:124, s:1, d:2.23, c:'#e4c94b'},
  {x:358, y:126, s:2, d:1.43, c:'#e4c94b'}, {x:367, y:129, s:1, d:1.59, c:'#e4c94b'},
];

// Grass blades (x, y=blade base, h=height, d=animation-delay)
const SCENE_GRASS: { x: number; y: number; h: number; d: number }[] = [
  {x:390,y:122,h:5,d:0.98},{x:168,y:129,h:3,d:1.38},{x:44, y:131,h:5,d:0.90},
  {x:349,y:132,h:2,d:0.19},{x:359,y:133,h:3,d:0.81},{x:361,y:134,h:3,d:0.61},
  {x:358,y:135,h:4,d:0.95},{x:348,y:136,h:4,d:0.85},{x:150,y:137,h:4,d:0.70},
  {x:37, y:138,h:5,d:0.54},{x:336,y:138,h:4,d:0.46},{x:209,y:139,h:3,d:0.63},
  {x:51, y:140,h:3,d:0.38},{x:341,y:140,h:5,d:0.55},{x:284,y:141,h:4,d:1.96},
  {x:64, y:142,h:3,d:0.59},{x:309,y:142,h:4,d:0.36},{x:86, y:143,h:2,d:1.42},
  {x:309,y:143,h:3,d:0.55},{x:99, y:144,h:2,d:1.11},{x:325,y:144,h:3,d:1.28},
  {x:100,y:145,h:5,d:0.21},{x:296,y:145,h:2,d:1.15},{x:94, y:146,h:5,d:0.96},
  {x:249,y:146,h:4,d:0.37},{x:351,y:146,h:2,d:0.50},{x:114,y:147,h:5,d:0.23},
  {x:256,y:147,h:2,d:0.80},{x:310,y:147,h:2,d:1.15},{x:115,y:148,h:2,d:0.30},
  {x:213,y:148,h:4,d:0.17},{x:291,y:148,h:3,d:0.24},{x:102,y:149,h:5,d:1.21},
  {x:175,y:149,h:3,d:1.55},{x:263,y:149,h:5,d:0.90},{x:96, y:150,h:5,d:0.59},
  {x:154,y:150,h:5,d:0.61},{x:221,y:150,h:2,d:1.22},{x:275,y:150,h:2,d:1.90},
  {x:120,y:151,h:3,d:1.25},{x:172,y:151,h:4,d:1.32},{x:224,y:151,h:3,d:0.48},
  {x:277,y:151,h:2,d:0.31},{x:140,y:152,h:5,d:0.90},{x:189,y:152,h:5,d:0.58},
  {x:240,y:152,h:3,d:0.58},{x:82, y:153,h:4,d:1.41},{x:162,y:153,h:5,d:0.14},
  {x:212,y:153,h:3,d:1.85},{x:274,y:153,h:3,d:0.85},{x:142,y:154,h:3,d:1.30},
  {x:196,y:154,h:4,d:1.65},{x:250,y:154,h:2,d:0.12},{x:129,y:155,h:4,d:1.19},
  {x:190,y:155,h:4,d:0.88},{x:245,y:155,h:5,d:1.38},{x:130,y:156,h:5,d:1.89},
  {x:209,y:156,h:5,d:0.88},{x:278,y:156,h:2,d:1.78},{x:191,y:157,h:4,d:1.21},
  {x:267,y:157,h:2,d:0.18},{x:165,y:158,h:2,d:2.00},{x:235,y:158,h:4,d:1.15},
  {x:160,y:159,h:3,d:0.94},{x:228,y:159,h:5,d:1.83},{x:169,y:160,h:3,d:1.99},
  {x:247,y:160,h:5,d:1.27},{x:200,y:161,h:5,d:1.94},{x:119,y:162,h:5,d:0.70},
  {x:206,y:162,h:4,d:0.64},{x:161,y:163,h:2,d:1.72},{x:220,y:163,h:4,d:0.82},
  {x:177,y:164,h:5,d:0.58},{x:106,y:165,h:5,d:1.63},{x:229,y:165,h:2,d:0.91},
  {x:195,y:166,h:4,d:0.50},{x:183,y:167,h:2,d:1.94},{x:162,y:168,h:5,d:1.73},
  {x:174,y:169,h:2,d:1.32},{x:192,y:170,h:5,d:0.83},
];
...
export class IntroComponent implements OnInit, OnDestroy {
  ...
  readonly sceneFlowers         = SCENE_FLOWERS;
  readonly sceneWhiteFlowers    = SCENE_WHITE_FLOWERS;
  readonly sceneCompoundFlowers = SCENE_COMPOUND_FLOWERS;
  readonly sceneGrass           = SCENE_GRASS;
